 ...
 * Original file: C:\\Users\\Administrator\\Desktop\\Des\\videoplayer\\src\\main\\aidl\\org\\videolan\\vlc\\interfaces\\IAudioService.aidl
 */
...
{
data.enforceInterface(DESCRIPTOR);
java.util.List<org.videolan.vlc.MediaWrapper> _result = this.getMedias();
reply.writeNoException();
...
@Override public java.util.List<org.videolan.vlc.MediaWrapper> getMedias() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<org.videolan.vlc.MediaWrapper> _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getMedias, _data, _reply, 0);
_reply.readException();
_result = _reply.createTypedArrayList(org.videolan.vlc.MediaWrapper.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
public java.util.List<org.videolan.vlc.MediaWrapper> getMedias() throws android.os.RemoteException;
